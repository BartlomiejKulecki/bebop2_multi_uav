...
{	
	...
	PositionController pc_follower2 = PositionController(zeros, "bebop_follower2");
...
// ----------------- gazebo -----------------------------------------------------------
	...
	pc_follower2.vel_pub = n.advertise<geometry_msgs::Twist>("/bebop_follower2/cmd_vel", 100);
	pc_follower2.data_pub = n.advertise<position_controller::msgData>("/position_controller_follower2_data", 100);
	pc_follower2.state_pub = n.advertise<std_msgs::Bool>("/bebop_follower2/state", 100);
	pc_follower2.odom_conv_pub = n.advertise<position_controller::msgCoordinates>("/bebop_follower2/odom_conv", 100);
	
//  ---------------  subscribers -------------------------------------------------------------------------
	pc_leader.odom_sub_gz = node->Subscribe("/gazebo/default/pose/info", &PositionController::update_pose_gz, &pc_leader);
	...
	pc_follower1.odom_sub_gz = node->Subscribe("/gazebo/default/pose/info", &PositionController::update_pose_gz, &pc_follower1);
	...
	pc_follower2.odom_sub_gz = node->Subscribe("/gazebo/default/pose/info", &PositionController::update_pose_gz, &pc_follower2);
	pc_follower2.target_sub = n.subscribe("/bebop_follower2/target", 100, &PositionController::update_target, &pc_follower2);
	pc_follower2.land_sub = n.subscribe("/bebop_follower2/land", 100, &PositionController::change_state_land, &pc_follower2);
	pc_follower2.reset_sub = n.subscribe("/bebop_follower2/reset", 100, &PositionController::change_state_land, &pc_follower2);
	pc_follower2.takeoff_sub = n.subscribe("/bebop_follower2/takeoff", 100, &PositionController::change_state_takeoff, &pc_follower2);
	pc_follower2.hover_sub = n.subscribe("/bebop_follower2/hover", 100, &PositionController::update_hover, &pc_follower2);
	
	dynamic_reconfigure::Server<position_controller::PIDConfig> server, server2, server3;
	dynamic_reconfigure::Server<position_controller::PIDConfig>::CallbackType f, f2, f3;
	...
	f3 = boost::bind(&PositionController::reconfig_callback, boost::ref(pc_follower2), _1);
	...
	pc_follower2.target_after_takeoff(init_altitude);
	...
	while (ros::ok())
	{
		...
		if(pc_follower2.flying() && !pc_follower2.hover)
			pc_follower2.control();
		ros::spinOnce();
		loop_rate.sleep();
	}
