...
class PositionController
{
	...
	public:	
		...
		ros::Subscriber odom_sub, target_sub, odom_sub, land_sub, takeoff_sub, reset_sub, hover_sub;
...
//  ---------------  subscribers -------------------------------------------------------------------------
	...
	pc_follower2.odom_sub = n.subscribe("/optitrack_node/optitrack2", 100, &PositionController::update_pose, &pc_follower2);
